...
public class EscidocConnector {
     ...
     * @throws RepositoryException
     */
    public static PostMethod requestRetrieveOrganizationalUnits(final String offset)
    throws RepositoryException {
        String body =
            "<param>" + "<limit>20</limit>" + "<offset>" + offset + "</offset>"
                + "</param>";
        String url = null;
        if (escidocUrl.endsWith("/")) {
            url = escidocUrl + "oum/organizational-units/filter";
        }
        else {
            url = escidocUrl + "/oum/organizational-units/filter";
        }

        return utility.post(url, body);
     ...
     * @throws RepositoryException
     */
    public static PostMethod requestRetrieveSetDefinitions(final String offset)
    throws RepositoryException {
        String body =
            "<param>" + "<limit>100</limit>" + "<offset>" + offset + "</offset>"
                + "</param>";
        String url = null;
        if (escidocUrl.endsWith("/")) {
            url = escidocUrl + "oai/set-definitions/filter";
        }
        else {
            url = escidocUrl + "/oai/set-definitions/filter";
        }
     ...
     * @throws RepositoryException
     */
    public static PostMethod requestRetrieveContexts(final String offset)
    throws RepositoryException {
        String body =
            "<param>" + "<limit>20</limit>" + "<offset>" + offset + "</offset>"
                + "</param>";
        String url = null;
        if (escidocUrl.endsWith("/")) {
            url = escidocUrl + "ir/contexts/filter";
        }
        else {
            url = escidocUrl + "/ir/contexts/filter";
        }
